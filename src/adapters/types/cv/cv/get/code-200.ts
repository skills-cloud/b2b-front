...
export type NoName127 = 10 | 20 | 30;
...
export interface CvRequestRequirementInlineSerializer {
    ...
    work_location_address?: NoName144;
...
export interface OrganizationProjectInline {
    created_at?: NoName113;
    date_from?: NoName114;
    date_to?: NoName115;
    description?: NoName116;
    id?: ID29;
    industry_sector?: IndustrySector;
    industry_sector_id?: NoName117;
    manager?: UserInline;
    manager_id?: NoName120;
    name: NoName121;
    organization?: Organization;
    organization_id: NoName122;
    recruiters?: UserInline[];
    recruiters_ids?: NoName123[];
    requests_count?: RequestsCount;
    resource_managers?: UserInline[];
    resource_managers_ids?: NoName124[];
    updated_at?: NoName125;
}
export interface UserInline {
    first_name: NoName118;
    id?: ID30;
    last_name: NoName119;
    photo?: Photo2;
}
export interface ProjectInline {
    created_at?: NoName128;
